...
class Env():
    ...
    def step(self, action):
        ...
        assert len(self.stack) == args.img_stack, f"stack length is : {len(self.stack)}"
        # print('hi1')
        # np.array(self.stack)
        # print('hi2')
...
def to_csv(tuple_list):
    df = pd.DataFrame(data=tuple_list, columns=['Episode_num', 'Score', 'Running Score'])
...
def run_train():
    ...
    for i_ep in range(10000):
        ...
        data_tuple = (i_ep, score, running_score)
